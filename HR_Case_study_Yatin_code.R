...
t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$Gender),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Gender",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Gender" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#There is no much variation in Males and Females in Attrition


#-----------------------------------Attrition Based on Job Level------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$JobLevel),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Job Level",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Job Level" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)
  

#Not much variation found based on Job Level for Attrition


#-----------------------------------Attrition Based on Job Role------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$JobRole),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Job Role",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Job Role" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)+
  theme(axis.text.x = element_text(angle = 90, vjust = 1, size = 10, hjust = 1))

#Research Directors are highly found to Attrite


#-----------------------------------Attrition Based on Marital Status------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$MaritalStatus),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Marital Status",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Marital Status" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#Single persons are highly found to Attrite


#-----------------------------------Attrition Based on Monthly Income------------------------------#


ggplot(as.data.frame(merge_emp_data4), aes(x = MonthlyIncome,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(1000, 100000, by = 10000),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Income",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Monthly Income" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))

#No Specific trend observed in Monthly Income


#-----------------------------------Attrition Based on Number of Companies Worked------------------------------#


t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$NumCompaniesWorked),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Number of Companies Worked",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Number of Companies Worked" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)


#No Specific trend observed in Number of Companies Worked on Attrition


#-----------------------------------Attrition Based on Stock Option level------------------------------#


t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$StockOptionLevel),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Stock Option level",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Stock Option level" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#No Specific trend observed in Stock Option level on Attrition


#-----------------------------------Attrition Based on Total Working Years------------------------------#

ggplot(as.data.frame(merge_emp_data4), aes(x = TotalWorkingYears,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(0, 40, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Total Working Years",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Total Working Years" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))

#People in initial years of their career tend to Attrite more


#-----------------------------------Attrition Based on Training Times Last Year------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$TrainingTimesLastYear),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Training Times Last Year",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Training Times Last Year" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#No Specific trend observed in Training Times Last Year on Attrition
...
ggplot(as.data.frame(merge_emp_data4), aes(x = YearsAtCompany,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(0, 40, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Total Working Years",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Years At Company" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))

#People in initial years of their company tend to Attrite more

#-----------------------------------Attrition Based on Years Since Last Promotion------------------------------#

ggplot(as.data.frame(merge_emp_data4), aes(x = YearsSinceLastPromotion,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(0, 15, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Years Since Last Promotion",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Years Since Last Promotion" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))

#No Specific trend observed here

#-----------------------------------Attrition Based on Years With Current Manager------------------------------#

ggplot(as.data.frame(merge_emp_data4), aes(x = YearsWithCurrManager,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(0, 15, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Years With Current Manager",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Years With Curr. Manager" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))
...
t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$EnvironmentSatisfaction),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Environment Satisfaction",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Environment Satisfaction" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#People who found low Environment Satisfaction mostly Attrite


#-----------------------------------Attrition Based on Job Satisfaction------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$JobSatisfaction),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Job Satisfaction",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Job Satisfaction" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#People who found low Job Satisfaction mostly Attrite


#-----------------------------------Attrition Based on Work Life Balance------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$WorkLifeBalance),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Work Life Balance",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Work Life Balance" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#People who found Bad Work Life Balance mostly Attrite


#-----------------------------------Attrition Based on Job Involvement------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$JobInvolvement),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Job Involvement",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Job Involvement" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#People who have Low and Very High Job Involvement mostly Attrite surprisingly


#-----------------------------------Attrition Based on Performance Rating------------------------------#

t<-prop.table(table(merge_emp_data4$Attrition,merge_emp_data4$PerformanceRating),2)

ggplot(as.data.frame(t), aes(x = Var2,y=Freq,fill=Var1)) +
  geom_bar(position="stack",stat="identity",col="black") +
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Performance Rating",y = "Percent of Attrition",
       title = "Fig 1: Proportion of Attrition Based on Performance Rating" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))+
  scale_y_continuous(labels = scales::percent)

#People who have both 3,4 Rating mostly Attrite 


#-----------------------------------Attrition Based on Time Per Day------------------------------#

ggplot(as.data.frame(merge_emp_data4), aes(x = timeperday,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(4, 12, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Time Per Day",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Time Per Day" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))

#No Specific trend observed here

#-----------------------------------Attrition Based on leaves------------------------------#

ggplot(as.data.frame(merge_emp_data4), aes(x = leaves,fill=factor(Attrition))) +
  geom_histogram(breaks=seq(10, 38, by = 1),col="black" )+
  theme(plot.title = element_text(hjust = 0.5)) +
  labs(x = "Leaves",y = "Attrition",
       title = "Fig 1: Proportion of Attrition Based on Leaves" ) +theme_HRcase()+
  guides(fill=guide_legend(title="Attrition"))
